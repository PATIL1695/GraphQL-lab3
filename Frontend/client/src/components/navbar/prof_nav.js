...
this.assignment = this.assignment.bind(this)
    ...
    return(
        ...
        <li class="active" data-toggle="collapse" data-target="#product" class="collapsed">
                ...
                <li class="active" data-toggle="collapse" data-target="#product1" class="collapsed">
                ...
                <li class="active" data-toggle="collapse" data-target="#product2" class="collapsed">
                    <a><i class="fa fa-gift fa-lg"></i> Quizzes <span class="arrow"></span></a>
                </li>
                <ul class="active" class="sub-menu collapse" id="product2">
                   {productResult2}
                </ul>
                <li class="active" data-toggle="collapse" data-target="#product4" class="collapsed">
                ...
                <li class="active" data-toggle="collapse" data-target="#product3" class="collapsed">
                ...
                <li class="active" data-toggle="collapse" data-target="#product5" class="collapsed">
